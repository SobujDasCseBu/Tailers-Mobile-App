  ...
  void initState() {
    ...
    getOrderDetails(widget.orderId).then((value) {
      setState(() {
        ...
        _isPoket = value['isPoket'];
        _isChain = value['isChain'];
        _isMotaShuta = value['isMotaShuta'];
        _isDoubleSelai = value['isDoubleSelai'];
        _isMotaRabar = value['isMotaRabar'];
        _is2Pocket = value['is2Pocket'];
        _isMobilePocket = value['isMobilePocket'];
        _isBendRoundColar = value['isBendRoundColar'];
        _isKotiColar = value['isKotiColar'];
        _isDoublePlate = value['isDoublePlate'];
        _isRoundcolar = value['isRoundcolar'];
        _isSinglePlate = value['isSinglePlate'];
        _isFull = value['isFull'];
        _isSamna = value['isSamna'];
        _isColar = value['isColar'];
        _isMura = value['isMura'];
        _isHata = value['isHata'];
        _isKop = value['isKop'];
        _isSidePocket = value['isSidePocket'];
        _isKandi = value['isKandi'];
        _isFullBodySita = value['isFullBodySita'];
        _isColarSingle = value['isColarSingle'];
        _isColarDouble = value['isColarDouble'];
        _isSamnaSita = value['isSamnaSita'];
        _isGolGola = value['isGolGola'];
        _isOneChain = value['isOneChain'];
        _isOneGuntiDana = value['isOneGuntiDana'];
        _is3GuntiDana = value['is3GuntiDana'];
                    ...
                    Form(
                      ...
                      child: Column(
                        children: [
                          ...
                          TextFormField(
                            maxLines: 2,
                            initialValue: orderDetails['clothName'],
                            decoration: InputDecoration(
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                child: TextFormField(
                                  initialValue:
                                      orderDetails['paidAmount'].toString(),
                                  decoration: InputDecoration(
                                      labelText: 'পেইড',
                                      border: OutlineInputBorder(
                                        borderRadius: BorderRadius.circular(5),
                          ...
                          Row(
                            children: [
                              Expanded(
                                child: TextFormField(
                                  initialValue: orderDetails['lomba'],
                                  decoration: InputDecoration(
                                      labelText: 'লম্বা',
                                      border: OutlineInputBorder(
                                        borderRadius: BorderRadius.circular(5),
                              ...
                              Expanded(
                                child: TextFormField(
                                  initialValue: orderDetails['payerMuhri'],
                                  decoration: InputDecoration(
                          ...
                          Row(
                            children: [
                              Expanded(
                                child: TextFormField(
                                  initialValue: orderDetails['hatarMuhri'],
                                  decoration: InputDecoration(
                              ...
                              Expanded(
                                child: TextFormField(
                                  initialValue: orderDetails['hiegh'],
                                  decoration: InputDecoration(
                                      labelText: 'হাই',
                                      border: OutlineInputBorder(
                                        borderRadius: BorderRadius.circular(5),
                          ...
                          Row(
                            children: [
                              Expanded(
                                child: TextFormField(
                                  initialValue: orderDetails['puut'],
                                  decoration: InputDecoration(
                                      labelText: 'পুটি',
                                      border: OutlineInputBorder(
                                        borderRadius: BorderRadius.circular(5),
                              ...
                              Expanded(
                                child: TextFormField(
                                  initialValue: orderDetails['body'],
                                  decoration: InputDecoration(
                                      labelText: 'বডি',
                                      border: OutlineInputBorder(
                                        borderRadius: BorderRadius.circular(5),
                          ...
                          Row(
                            children: [
                              Expanded(
                                child: TextFormField(
                                  initialValue: orderDetails['hata'],
                                  decoration: InputDecoration(
                                      labelText: 'হাতাই',
                                      border: OutlineInputBorder(
                                        borderRadius: BorderRadius.circular(5),
                              ...
                              Expanded(
                                child: TextFormField(
                                  initialValue: orderDetails['kolarToyri'],
                                  decoration: InputDecoration(
                                      labelText: 'কলার তৈরি',
                                      border: OutlineInputBorder(
                          ...
                          Row(
                            children: [
                              Expanded(
                                child: TextFormField(
                                  initialValue: orderDetails['komor'],
                                  decoration: InputDecoration(
                                      labelText: 'কোমর',
                                      border: OutlineInputBorder(
                                        borderRadius: BorderRadius.circular(5),
